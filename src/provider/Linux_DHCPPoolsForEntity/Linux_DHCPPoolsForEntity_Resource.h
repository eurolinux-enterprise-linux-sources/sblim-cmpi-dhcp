...
#define _ASSOCCLASS "Linux_DHCPPoolsForEntity"
#define _LHSCLASSNAME "Linux_DHCPPool"
...
int Linux_DHCPPoolsForEntity_isAssociated (CMPIObjectPath*, CMPIObjectPath*);

/** Get a handle to the list of all system resources for this class. */
_RA_STATUS Linux_DHCPPoolsForEntity_getResources( const CMPIBroker *, const CMPIContext*, const CMPIObjectPath*, _RESOURCES ** resources, int);

/** Free/deallocate/cleanup the resources list after use. */
_RA_STATUS Linux_DHCPPoolsForEntity_freeResources( _RESOURCES * resources);

/** Iterator to get the next resource from the resources list. */
_RA_STATUS Linux_DHCPPoolsForEntity_getNextResource( _RESOURCES * resources, _RESOURCE ** resource);

/** Get the specific resource that matches the CMPI object path. */
_RA_STATUS Linux_DHCPPoolsForEntity_getResourceForObjectPath( const CMPIBroker *, const CMPIContext*, _RESOURCES * resources, _RESOURCE ** resource, const CMPIObjectPath * objectpath);

/** Free/deallocate/cleanup a resource after use. */
_RA_STATUS Linux_DHCPPoolsForEntity_freeResource( _RESOURCE * resource);

/** Set the property values of a CMPI instance from a specific resource. */
_RA_STATUS Linux_DHCPPoolsForEntity_setInstanceFromResource( _RESOURCE * resource, const CMPIInstance * instance, const CMPIBroker * broker);

/// THE FOLLOWING METHODS MAY/NOT BE SUPPORTED BY THE SYSTEM FOR THIS CLASS

/** Delete the specified resource from the system. */
_RA_STATUS Linux_DHCPPoolsForEntity_deleteResource( _RESOURCES * resources, _RESOURCE * resource);

/** Create a new resource using the property values of a CMPI instance. */
_RA_STATUS Linux_DHCPPoolsForEntity_createResourceFromInstance( _RESOURCES * resources, _RESOURCE ** resource, const CMPIInstance * instance, const CMPIBroker * broker);
