...
#define _ASSOCCLASS "Linux_DHCPOptionsForEntity"
#define _LHSCLASSNAME "Linux_DHCPOptions"
...
int Linux_DHCPOptionsForEntity_isAssociated (CMPIObjectPath*, CMPIObjectPath*);

/** Get a handle to the list of all system resources for this class. */
_RA_STATUS Linux_DHCPOptionsForEntity_getResources( const CMPIBroker *, const CMPIContext*, const CMPIObjectPath*, _RESOURCES ** resources);
...
_RA_STATUS Linux_DHCPOptionsForEntity_getResourceForObjectPath( const CMPIBroker *, const CMPIContext*, _RESOURCES * resources, _RESOURCE ** resource, const CMPIObjectPath * objectpath);
