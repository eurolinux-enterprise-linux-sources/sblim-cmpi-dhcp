...
#define _ASSOCCLASS "Linux_DHCPHostsForEntity"
#define _LHSCLASSNAME "Linux_DHCPHost"
...
int Linux_DHCPHostsForEntity_isAssociated (CMPIObjectPath*, CMPIObjectPath*);

/** Get a handle to the list of all system resources for this class. */
_RA_STATUS Linux_DHCPHostsForEntity_getResources( const CMPIBroker *, const CMPIContext*, const CMPIObjectPath*, _RESOURCES ** resources, int);
...
_RA_STATUS Linux_DHCPHostsForEntity_getResourceForObjectPath( const CMPIBroker *, const CMPIContext*, _RESOURCES * resources, _RESOURCE ** resource, const CMPIObjectPath * objectpath);
