...
#define _CLASSNAME "Linux_DHCPGlobal"
...
bool Global_isEnumerateInstanceNamesSupported();
bool Global_isEnumerateInstancesSupported();
bool Global_isGetSupported();
bool Global_isCreateSupported( );
bool Global_isModifySupported( );
bool Global_isDeleteSupported( );
...
_RA_STATUS Linux_DHCPGlobal_InstanceProviderInitialize();

/** CleanUp method for Instance Provider */
_RA_STATUS Linux_DHCPGlobal_InstanceProviderCleanUp(bool terminate);
