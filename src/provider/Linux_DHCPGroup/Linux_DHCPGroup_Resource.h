...
#define _CLASSNAME "Linux_DHCPGroup"
...
bool Group_isEnumerateInstanceNamesSupported();
bool Group_isEnumerateInstancesSupported();
bool Group_isGetSupported();
bool Group_isCreateSupported( );
bool Group_isModifySupported( );
bool Group_isDeleteSupported( );
...
_RA_STATUS Linux_DHCPGroup_InstanceProviderInitialize( _RA_STATUS* );

/** CleanUp method for Instance Provider */
_RA_STATUS Linux_DHCPGroup_InstanceProviderCleanUp(bool terminate);

/** Build object path method for Instance Provider */
_RA_STATUS Linux_DHCPGroup_BuildObjectPath(CMPIObjectPath* , CMPIInstance* , char* , _RESOURCE* );
