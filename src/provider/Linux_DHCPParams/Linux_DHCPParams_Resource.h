...
#define _CLASSNAME "Linux_DHCPParams"
...
bool Param_isEnumerateInstanceNamesSupported();
bool Param_isEnumerateInstancesSupported();
bool Param_isGetSupported();
bool Param_isCreateSupported( );
bool Param_isModifySupported( );
bool Param_isDeleteSupported( );
...
_RA_STATUS Linux_DHCPParams_InstanceProviderInitialize( _RA_STATUS* );

/** CleanUp method for Instance Provider */
_RA_STATUS Linux_DHCPParams_InstanceProviderCleanUp(bool terminate);

///----------------------------------------------------------------------------
/** Build object path method for Instance Provider */
_RA_STATUS Linux_DHCPParams_BuildObjectPath(CMPIObjectPath* , CMPIInstance* , char* , _RESOURCE* );
