...
#define _CLASSNAME "Linux_DHCPSharednet"
...
bool Sharednet_isEnumerateInstanceNamesSupported();
bool Sharednet_isEnumerateInstancesSupported();
bool Sharednet_isGetSupported();
bool Sharednet_isCreateSupported( );
bool Sharednet_isModifySupported( );
bool Sharednet_isDeleteSupported( );
...
_RA_STATUS Linux_DHCPSharednet_InstanceProviderInitialize( _RA_STATUS* );

/** CleanUp method for Instance Provider */
_RA_STATUS Linux_DHCPSharednet_InstanceProviderCleanUp(bool terminate);

///----------------------------------------------------------------------------
/** Build object path method for Instance Provider */
_RA_STATUS Linux_DHCPSharednet_BuildObjectPath(CMPIObjectPath* , CMPIInstance* , char* , _RESOURCE* );
