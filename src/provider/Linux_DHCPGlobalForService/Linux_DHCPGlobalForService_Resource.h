...
#define _ASSOCCLASS "Linux_DHCPGlobalForService"
#define _LHSCLASSNAME "Linux_DHCPGlobal"
#define _RHSCLASSNAME "Linux_DHCPService"
#define _LHSPROPERTYNAME "SettingData"
#define _RHSPROPERTYNAME "ManagedElement"
...
bool Linux_DHCPGlobalForService_isAssociated (CMPIObjectPath*, CMPIObjectPath*);

/** Get a handle to the list of all system resources for this class. */
_RA_STATUS Linux_DHCPGlobalForService_getResources( const CMPIBroker *, const CMPIContext*, const CMPIObjectPath*, _RESOURCES ** resources);
...
_RA_STATUS Linux_DHCPGlobalForService_getResourceForObjectPath( const CMPIBroker *, const CMPIContext*, _RESOURCES * resources, _RESOURCE ** resource, const CMPIObjectPath * objectpath);
