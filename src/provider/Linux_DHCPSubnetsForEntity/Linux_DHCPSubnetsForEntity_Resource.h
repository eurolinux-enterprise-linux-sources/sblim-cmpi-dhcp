...
#define _ASSOCCLASS "Linux_DHCPSubnetsForEntity"
#define _LHSCLASSNAME "Linux_DHCPSubnet"
...
int Linux_DHCPSubnetsForEntity_isAssociated (CMPIObjectPath*, CMPIObjectPath*);

/** Get a handle to the list of all system resources for this class. */
_RA_STATUS Linux_DHCPSubnetsForEntity_getResources( const CMPIBroker *, const CMPIContext*, const CMPIObjectPath*, _RESOURCES ** resources, int);
...
_RA_STATUS Linux_DHCPSubnetsForEntity_getResourceForObjectPath( const CMPIBroker *, const CMPIContext*, _RESOURCES * resources, _RESOURCE ** resource, const CMPIObjectPath * objectpath);
