...
#define _ASSOCCLASS "Linux_DHCPGroupsForEntity"
#define _LHSCLASSNAME "Linux_DHCPGroup"
...
int Linux_DHCPGroupsForEntity_isAssociated (CMPIObjectPath*, CMPIObjectPath*);

/** Get a handle to the list of all system resources for this class. */
_RA_STATUS Linux_DHCPGroupsForEntity_getResources( const CMPIBroker *, const CMPIContext*, const CMPIObjectPath*, _RESOURCES ** resources, int);
...
_RA_STATUS Linux_DHCPGroupsForEntity_getResourceForObjectPath( const CMPIBroker *, const CMPIContext*, _RESOURCES * resources, _RESOURCE ** resource, const CMPIObjectPath * objectpath);
