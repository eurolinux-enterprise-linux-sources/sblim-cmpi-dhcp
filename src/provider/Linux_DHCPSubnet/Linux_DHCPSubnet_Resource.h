...
#define _CLASSNAME "Linux_DHCPSubnet"
...
bool Subnet_isEnumerateInstanceNamesSupported();
bool Subnet_isEnumerateInstancesSupported();
bool Subnet_isGetSupported();
bool Subnet_isCreateSupported( );
bool Subnet_isModifySupported( );
bool Subnet_isDeleteSupported( );
...
_RA_STATUS Linux_DHCPSubnet_InstanceProviderCleanUp(bool terminate);

///----------------------------------------------------------------------------
/** Build object path method for Instance Provider */
_RA_STATUS Linux_DHCPSubnet_BuildObjectPath(CMPIObjectPath* , CMPIInstance* , char* , _RESOURCE* );
